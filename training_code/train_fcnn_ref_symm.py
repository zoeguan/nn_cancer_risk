...
nn_input = pd.read_csv('../nn_input/nn_input_percent' + str(perc) + 'symm.csv', low_memory=False)
...
filename = "../results/res_symm_percent" + str(perc) + "_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"


results_df = pd.DataFrame(data=results)
results_df.to_csv(filename)

filename2 = "../results/pred_symm_percent" + str(perc) + "_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
