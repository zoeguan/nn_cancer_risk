...
fcnn.compile(loss='binary_crossentropy', optimizer='Adam')
...
filename = "../results/res_ce_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"


results_df = pd.DataFrame(data=results)
results_df.to_csv(filename)

filename2 = "../results/pred_ce_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
