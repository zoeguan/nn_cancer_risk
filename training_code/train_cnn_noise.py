...
cnn_input = pd.read_csv('../nn_input/cnn_input_noise.csv', low_memory=False)
...
filename = "../results/res_cnn_noise" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
...
pred_df.to_csv('../results/pred_cnn_noise.csv')
