...
results ={'auc': perf[0:3],
         'oe': perf[3:6],
         'bs': perf[6:9],
         'auc_brca': perf_brca[0:3],
         'oe_brca': perf_brca[3:6],
         'bs_brca': perf_brca[6:9]}

filename = "../results/res_noise" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
...
filename2 = "../results/pred_noise" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
