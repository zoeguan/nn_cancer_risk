...
pred_all = pd.read_csv('../results/pred_all.csv')
pred_brca = pred_all.iloc[:, 1]
pred_fcnn = pred_all.iloc[:, 3]
pred_cnn = pred_all.iloc[:, 2]
pred_lr = pred_all.iloc[:, 4]
...
prauc_df.to_csv('../results/prauc_boot.csv')
