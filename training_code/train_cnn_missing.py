...
cnn_input = pd.read_csv('../nn_input/cnn_input_' + suffix + '.csv', low_memory=False)
...
filename = "../results/res_cnn_" + suffix + "_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
...
#filename2 = "../results/pred_cnn_" + suffix + "_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
