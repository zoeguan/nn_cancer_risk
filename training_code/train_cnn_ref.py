...
cnn_input = pd.read_csv('../nn_input/cnn_input_percent' + str(perc) + '.csv', low_memory=False)
graph_mat = pd.read_csv('../nn_input/graph_mat_percent' + str(perc) + '.csv')
...
filename = "../results/res_cnn_percent" + str(perc) + "_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
...
filename2 = "../results/pred_cnn_percent" + str(perc) + "_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
