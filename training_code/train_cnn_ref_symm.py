...
cnn_input = pd.read_csv('../nn_input/cnn_input_percent' + str(perc) + 'symm.csv', low_memory=False)
graph_mat = pd.read_csv('../nn_input/graph_mat_percent' + str(perc) + 'symm.csv')
...
perf = boot(pred_cnn, y_test)
cor = boot_cor(pred_cnn, pred_brca)
...
filename = "../results/res_cnn_symm_percent" + str(perc) + "_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
...
filename2 = "../results/pred_cnn_symm_percent" + str(perc) + "_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
