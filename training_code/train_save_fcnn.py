...
filepath = "fcnn_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".h5"
fcnn.save(filepath)
...
filename = "../results/res_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"


results_df = pd.DataFrame(data=results)
results_df.to_csv(filename)

filename2 = "../results/pred_" + str(max_train) + "_" + str(epochs) + "_" + str(seed_value) + ".csv"
