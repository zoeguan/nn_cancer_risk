...
sizes1 = [10, 10, 20, 30, 30]
sizes2 = [10, 30, 20, 30, 10]
bs = list()
auc = list()
...
for i in range(len(sizes1)):
    print(i)
    fcnn = Sequential()
    fcnn.add(Dense(sizes1[i], input_shape=(X_train.shape[1],), activation='elu'))
    fcnn.add(Dense(sizes2[i], activation='elu') )
...
perf_df.to_csv('../tuning_results/tune_fcnn2a.csv')
