...
hidden_layers_list = list(itertools.product(nodes_list, nodes_list)) + list(itertools.product(nodes_list, nodes_list, nodes_list))
...
results_df.to_csv("../tuning_results/tunec_" + str(max_train) + "_" + str(seed_value) + "_" + str(niter) + ".csv")
