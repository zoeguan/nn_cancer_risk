...
for (i in prop.missing) {
  ...
  write.csv(nn.input.i, file=paste0("../nn_input/nn_input_missingages", i, ".csv"))
  ...
  write.csv(cnn.input, file=paste0("../nn_input/cnn_input_missingages", i, ".csv"))
}
...
for (i in prop.missing) {
  ...
  save(nn.input.i, file=paste0("../nn_input/nn_input_missingrels", i, ".RData"))
  write.csv(nn.input.i, file=paste0("../nn_input/nn_input_missingrels", i, ".csv"))
  
  cnn.input = nn.input.i[, which(!grepl("FDR|SDR|brcapro|BC.", names(nn.input.i)))]
  cnn.input[, c("Gender_null", "AffB_null", "AgeB_null", "AffO_null", "AgeO_null", "Age_null", "Miss_null")] = 0
  cnn.input$Miss_null = 1
  cnn.input[, c("FDR", "SDR", "brcapro5", "brcapro10", "BC.5", "BC.10")] = nn.input.i[, c("FDR", "SDR", "brcapro5", "brcapro10", "BC.5", "BC.10")]
  write.csv(cnn.input, file=paste0("../nn_input/cnn_input_missingrels", i, ".csv"))
}
...
for (i in prop.missing) {
  ...
  save(nn.input.i, file=paste0("../nn_input/nn_input_missingunaff", i, ".RData"))
  write.csv(nn.input.i, file=paste0("../nn_input/nn_input_missingunaff", i, ".csv"))
  
  cnn.input = nn.input.i[, which(!grepl("FDR|SDR|brcapro|BC.", names(nn.input.i)))]
  cnn.input[, c("Gender_null", "AffB_null", "AgeB_null", "AffO_null", "AgeO_null", "Age_null", "Miss_null")] = 0
  cnn.input$Miss_null = 1
  cnn.input[, c("FDR", "SDR", "brcapro5", "brcapro10", "BC.5", "BC.10")] = nn.input.i[, c("FDR", "SDR", "brcapro5", "brcapro10", "BC.5", "BC.10")]
  write.csv(cnn.input, file=paste0("../nn_input/cnn_input_missingunaff", i, ".csv"))
}
